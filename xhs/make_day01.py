...
b_progress = box(
    "#eef7ff", "#9ec9ee", "🎯 Day 1 / 30 · 目标 1000 粉", "#0a3d62",
    '<p style="margin:0 0 6px;">拆解一下这个目标，它其实没那么吓人：</p>'
    '<p style="margin:0 0 4px;">· <b>1000 粉 ÷ 30 天 ≈ 每天 33 粉</b>。小红书图文大致是「每 100 赞涨 1–3 粉」，'
    ...
    '<p style="margin:0 0 4px;">· <b>今天只做 3 件事</b>：发第 1 篇 → 把主页简介改成「GEO 从业者｜用 30 天拆明白 AI 搜索」→ 建一个选题池备忘录。</p>'
...
b_topic = (
    ...
    + '<p class="ct-h">🖼 封面建议</p>'
    + '<div class="ct-body ph">白底 / 米黄底，<b>纯黑大字</b>，字要大到缩略图里也看得清：<br/>'
    '主文案「<b>AI 里搜不到你 = 你不存在</b>」，<br/>'
    '右下角小字「第 1 天｜一个答不上老板问题的市场人」。<br/>'
...
b_action = box(
    ...
    '<p style="margin:0 0 6px;"><b>3. 建选题池：</b>备忘录新建「30 天选题池」，把评论区和私信里出现的每个行业、每个问题都记下来。'
    '这些人问的，就是你后面 29 天要写的。</p>'
...
entry = {
    ...
    "blocks": [
        {"h": "🎯 30 天涨粉进度 · Day 1", "body": b_progress},
        {"h": "📕 今日选题", "body": b_topic},
