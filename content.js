...
const CONTENT = {
    ...
    "blocks": [
      {
        ...
        "body": "<div style='background:#e6f1fb;border:1px solid #85b7eb;border-radius:12px;padding:12px 14px;'><div style='display:flex;justify-content:space-between;align-items:center;margin-bottom:8px;'><b style='font-size:14px;color:#0c447c;'>📊 抖音账号分析</b><span style='font-size:11px;color:#185fa5;background:#caf0f8;padding:2px 8px;border-radius:10px;'>已同步 2026-08-12</span></div><div style='font-size:12.5px;line-height:1.75;color:#2c2c2a;'><p style='margin:0 0 4px;'><b>近7日：</b>播放 <b>1.3万</b>(-26.8%)｜点赞 <b>1745</b>(+1242%)｜完播率 <b>2.8%</b></p><p style='margin:0 0 4px;'><b>排名：</b>超越 <b>98.53%</b> 同类作者｜互动率 <b>15.2%</b>(同类6.5%)</p><p style='margin:0 0 4px;'><b>🔥 爆款：</b>撸狗/全心犬意 1.3万播/1783赞/233评，获5585流量激励，+5粉</p><p style='margin:0 0 4px;'><b>⚠️ 短板：</b>完播率仅2.8%(↓81.6%)；投稿量-50%；主页访问-65.9%</p><p style='margin:0 0 4px;'><b>💡 方向：</b>复制撸狗(真实+情感)；前3秒抛冲突救完播；周更2-3篇</p><p style='margin:6px 0 0;font-size:11.5px;color:#5f5e5a;'>发最新截图给我即可更新本卡片。</p></div></div>"
      },
      {
        "h": "🔥 本周推荐：街头采访 / 路人问卷",
  ...
  {
    "title": "抖音内容推荐 · 第 8 周｜图文短视频 × 深圳辣馆连载",
    "tag": "第8周 · 每周一篇",
    "blocks": [
      {
        "h": "📊 我的抖音账号分析（153146893）",
      ...
      {
        "h": "🔥 本周推荐：图文短视频 × 深圳辣馆连载",
        "body": "<p><b>抓住 8 月最大红利：</b>抖音本月全平台上线「图文短视频」（图片轮播＋文字＋BGM）。官方给了<b>双流量池</b>——推荐流量 70% ＋ 搜索流量 30%，图文的搜索曝光约是口播视频的 <b>4.2 倍</b>。更关键的是完播口径换成了「阅读完成率」（用户滑到最后一张即算），比拍视频冲完播率轻松得多，而你目前的视频完播率是 19.07%。</p><p class=\"ct-h\">💡 为什么这周做这个</p><div class=\"ct-body ph\">① 你的短板不是流量，是<b>互动率 1%、流量不转粉</b>——人字拖那条 11.9 万播没留住人，因为观众<b>没有理由关注你</b>，看完就走。<br/>② 2026 新算法重看<b>收藏 / 复访 / 铁粉互动</b>，<b>系列化连载</b>是目前最有效的解法：用户为了追下一期才点关注。<br/>③ 图文一条 30 分钟就能出，下班后也能稳定日更 2–3 条（日更 2 条约 +15% 流量，3 条约 +30%）。<br/>④ 深圳 ＋ 爱辣 ＋ 冰美式本来就是你的日常，不用演、素材天然管够。</div><p class=\"ct-h\">🎬 拍摄脚本（图文 6 张）</p><div class=\"ct-body ph\">先定死栏目名：<b>《深圳辣馆打卡 · 第 N 家》</b>，一期只讲一家店。<br/>① <b>封面</b>：辣菜特写占满画面 ＋ 大字「深圳辣馆 #008」＋ 小字店名 / 人均<br/>② 图2：门头实拍（让人搜得到、找得着）<br/>③ 图3–4：招牌菜各一张，配一句真实评价（辣度几级、值不值这个价）<br/>④ 图5：<b>避雷提醒</b>（排队多久、几点去、哪道别点）——这张收藏率最高<br/>⑤ 图6：钩子「下一家想看我探哪个区？评论区点单」<br/>拍摄：手机原相机即可，前 3 张必须高清＋高饱和；一次探店尽量拍够 3 期的量。</div><p class=\"ct-h\">✍️ 标题 / 文案示例（前半句喂搜索，后半句勾点击）</p><div class=\"ct-body ph\">「深圳湘菜推荐 ｜ 这家辣到我灌了三杯冰美式，人均 58」<br/>「深圳探店 ｜ 藏在写字楼负一层的辣馆，打工人午饭天花板」<br/>「深圳美食 ｜ 连吃 7 家辣馆后，我只回头了这一家」</div><p class=\"ct-h\">🎲 顺手可蹭的热点</p><p>「26 版西游记 / 打工人团建」梗仍在爆（相关话题播放已超 5 亿）。可加拍一条混搭：<b>「如果师徒四人在深圳吃辣」</b>——唐僧点鸳鸯锅、悟空全红汤、八戒只惦记甜品、沙僧默默买单。成本极低、蹭现成流量，又不脱离你的美食垂类。</p><p class=\"ct-h\">🏷️ 话题标签</p><p>#深圳美食 #深圳探店 #深圳辣馆 #打工人午餐 #图文短视频 #城市生活</p>"
      },
      {
        "h": "✅ 本周行动清单",
        "body": "<p>① <b>今天</b>：给栏目起名，做一张固定封面模板（Canva 或醒图存成模板，之后每期只换图和编号）；<br/>② <b>本周内</b>：挑 3 家深圳辣馆，一次性拍够 3 期图文素材，周二 / 周四 / 周六各发一条；<br/>③ 每条标题前半句务必写「深圳＋菜系＋区域」，专吃搜索流量池；<br/>④ <b>治互动率</b>：结尾固定「下一家点单」，发布后 2 小时内回完前 20 条评论，每条都反问一句；<br/>⑤ <b>治转粉</b>：主页简介改成「深圳辣馆连载中 · 已探 N 家」，让点进来的人有关注的理由；<br/>⑥ <b>周日复盘</b>：对比图文的「阅读完成率」和视频的 19.07% 完播率，哪个跑得好就把主力压过去。</p>"
      }
    ]
  }
]
